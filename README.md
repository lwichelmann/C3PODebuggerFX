...
A JavaFX desktop debugger for the [C3PO scripting language](https://github.com/lwichelmann/C3PO).

C3PO is a custom interpreted language (`c3po.exe`). This tool attaches to a
